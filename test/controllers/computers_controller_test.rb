...
class ComputersControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create computer" do
    assert_difference('Computer.count') do
      post computers_url, params: { computer: { car_id: @computer.car_id, status: @computer.status } }, as: :json
    end
  ...
  test "should update computer" do
    patch computer_url(@computer), params: { computer: { car_id: @computer.car_id, status: @computer.status } }, as: :json
    assert_response 200
  end
