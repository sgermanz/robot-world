...
class WarehousesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create warehouse" do
    assert_difference('Warehouse.count') do
      post warehouses_url, params: { warehouse: { model_id: @warehouse.model_id, stock: @warehouse.stock } }, as: :json
    end
  ...
  test "should update warehouse" do
    patch warehouse_url(@warehouse), params: { warehouse: { model_id: @warehouse.model_id, stock: @warehouse.stock } }, as: :json
    assert_response 200
  end
